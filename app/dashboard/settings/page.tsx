...
const PLANS = [
  {
    ...
    features: ['Pipeline kanban', 'Relances prospects auto', 'Facturation intégrée', 'Relances factures auto', 'Support email'],
    icon: Zap,
    color: 'text-blue-600',
  ...
  },
  {
    ...
    features: ['Tout Pro +', 'API & webhooks', 'Multi-utilisateurs', 'Account manager dédié', 'SLA 99.9%'],
    icon: Rocket,
